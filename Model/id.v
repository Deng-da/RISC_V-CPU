...
always @(*) begin
    ...
    if (rst == 1'b1) begin
        ...
        reg_1 = ex_wb_data;
    end else if (re_1 && mem_reg_write && mem_is_load && (mem_wb_addr != 5'h0) && (reg_1_addr == mem_wb_addr)) begin
        stallask_from_reg1 = 1'b1;
...
always @(*) begin
    ...
    if (rst == 1'b1) begin
        ...
        end else if (re_2 && mem_reg_write && mem_is_load && (mem_wb_addr != 5'h0) && (reg_2_addr == mem_wb_addr)) begin
            stallask_from_reg2 = 1'b1;
