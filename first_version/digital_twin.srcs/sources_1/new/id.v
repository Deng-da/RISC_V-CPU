    ...
    if (rst == 1'b1) begin
        ...
        case (opcode)
            ...
            7'b0000011: begin
                ...
                imm_o      = imm_i;
                case (funct3)
                    3'b000: alu_op = ALU_LB;
                    3'b001: alu_op = ALU_LH;
                    3'b010: alu_op = ALU_LW;
                    3'b100: alu_op = ALU_LBU;
                    3'b101: alu_op = ALU_LHU;
                    default: begin
                        reg_write = 1'b0;
                        alu_op    = ALU_NOP;
                    end
            ...
            7'b0100011: begin
                ...
                imm_o = imm_s;
                case (funct3)
                    3'b000: alu_op = ALU_SB;
                    3'b001: alu_op = ALU_SH;
                    3'b010: alu_op = ALU_SW;
...
always @(*) begin
    ...
    end else if (re_2 && ex_reg_write && (ex_wb_addr != 5'h0) && (reg_2_addr == ex_wb_addr)) begin
        reg_2 = ex_wb_data;
