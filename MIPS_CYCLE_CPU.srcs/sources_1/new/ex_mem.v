            ...
            case(ex_mem_op)
                3'b011:begin//sb
                    ...
                    case(ex_mem_addr[1:0])
                        2'b00:begin
                            last_store_data  <= {24'h0,ex_mem_data[7:0]};
                        end
                        2'b01:begin
                            last_store_data  <= {16'h0,ex_mem_data[7:0],8'h0};
                        end
                        2'b10:begin
                            last_store_data  <= {8'h0,ex_mem_data[7:0],16'h0};
                        end
                        2'b11:begin
                            last_store_data  <= {ex_mem_data[7:0],24'h0};
                        end
                        default:begin
                            last_store_data  <= last_store_data;
                        end
