...
module MIPS_top(
    ...
    .stall           (stall)
     ...
     wire              stallask_from_if;
     
     icache u_icache(
    .clk             (clk),
    .rst             (rst),
    .cpu_addr        (pc_to_cache),
    .cpu_req         (pc_ce_to_cache),
    .cpu_rdata       (inst_from_cache),
    .cpu_stall       (stallask_from_if),
    .sram_addr       (base_ram_addr),
    .sram_ce_n       (base_ram_ce_n),
    .sram_oe_n       (base_ram_oe_n),
    .sram_rdata      (base_ram_rdata)
...
//reg_file模块   
//id与reg_file模块之间的信息i,o是相对于reg_file来说的   
    //来自reg_file读取出的数据
...
//id模块    
    ...
    wire            this_inst_is_load;//来自ex模块的输出
    
    wire            stallask_from_id;//送往stall_ctrl模块
    ...
    stall_ctrl stall_ctrl1(
        .rst                (rst),
        .stallask_from_if   (stallask_from_if),
